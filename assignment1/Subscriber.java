...
public class Subscriber{
	...
	public static void main(String[] args) {
		...
		String data;
		byte[] header;
		byte[] wind = {1,2,3,4,6,0,0,2};
		byte[] temp = {1,2,3,4,6,0,0,1};
		byte[]humidity= {1,2,3,4,6,0,0,3};
		...
		try {
			...
			ostreamSend.writeUTF("subscribing");
			ostreamSend.flush();
			...
			System.out.println("subscribe to anothor topic y/n");
