...
public class Router1{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("R1- Program start");

			// extract destination from arguments
			address= InetAddress.getByName("e1");
			port= PORT;                     
			...
			System.out.println("R1 : Trying to receive");
			...
			System.out.println("R1 : recieved Program end");

           
			System.out.println("R1 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("R1 : topic sent - Program end");
