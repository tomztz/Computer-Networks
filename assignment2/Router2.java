...
public class Router2{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("R2- Program start");
			...
			System.out.println("R2 : Trying to receive");
			...
			System.out.println("R2 : recieved Program end");

           
			System.out.println("R2 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("R2 : topic sent - Program end");
