...
public class Router3{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("R3- Program start");
			...
			System.out.println("R3 : Trying to receive");
			...
			System.out.println("R3 : recieved Program end");

           
			System.out.println("R3 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("R3 : topic sent - Program end");
