...
public class Router4{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("R4- Program start");
			...
			System.out.println("R4 : Trying to receive");
			...
			System.out.println("R4 : recieved Program end");

           
			System.out.println("R4 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("R4 : topic sent - Program end");
