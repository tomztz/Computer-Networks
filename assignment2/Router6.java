...
public class Router6{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("R6- Program start");
			...
			System.out.println("R6 : Trying to receive");
			...
			System.out.println("R6 : recieved Program end");

           
			System.out.println("R6 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("R6 : topic sent - Program end");
