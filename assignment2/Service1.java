...
public class Service1{
	...
	public static void main(String[] args) {
		final int PORT_R = 51510;	
		final int PORT_APP =53521;
		final int MTU = 1500;
		...
		try {
			...
			System.out.println("Service1- Program start");
			...
			System.out.println("Service1 : Trying to receive");
			...
			System.out.println("Service1 : recieved Program end");

           
			System.out.println("Service1 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("Service1 : topic sent - Program end");

			
			}
			if(addressID.equals("e4")){
