...
public class Service2{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Service2- Program start");
			...
			System.out.println("Service2 : Trying to receive");
			...
			System.out.println("Service2 : recieved Program end");

           
			System.out.println("Service2 : sending topic - Program start");
			...
			if(hasAdd == false){
				...
				System.out.println("Service2 : topic sent - Program end");
